...
public class AccountSponsoringRequestParamsJsonTests extends AbstractJsonTest {
  ...
  void testFromOnlyAddress() throws JSONException, JsonProcessingException {
    AccountSponsoringRequestParams params = AccountSponsoringRequestParams.of(
      Address.of("rSponsor1VktvzBz8JF2oJC6qaww6RZ7Lw")
    );
